...
namespace WebApplication.Config
{
    public class SearchEngine
    {
        ...
        private static string CleanContent(string content, bool removeHtml)
        {
            ...
            foreach (var word in words.Select
                (t => t.ToLowerInvariant().Trim()).Where(word => word.Length > 1))
            {
        ...
        public static IEnumerable<ApplicationUser> Search(string searchString, IQueryable<ApplicationUser> source)
        {
